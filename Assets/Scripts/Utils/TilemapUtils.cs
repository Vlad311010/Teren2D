...
public static class TilemapUtils
{
    ...
    public static T GetTileFromCollision<T>(Tilemap tilemap, Collision collision) where T : Tile
    {
    ...
    public static T GetTile<T>(Tilemap tilemap, Vector3 coordinates) where T : Tile
    {
        return GetTile<T>(tilemap, tilemap.WorldToCell(coordinates));
    }

    public static T GetTile<T>(Tilemap tilemap, Vector3Int coordinates) where T : Tile
    {
        return tilemap.GetTile<T>(coordinates);
    }

    public static void SetTile(Tilemap tilemap, Vector3 coordinates, Tile tile)
    {
